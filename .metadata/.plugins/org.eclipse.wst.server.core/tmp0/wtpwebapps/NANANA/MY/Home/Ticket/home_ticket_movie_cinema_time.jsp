			...
			<tr>
	    		...
	    		<td style="border-left : 1px solid #5D5D5D;border-right : 1px solid #5D5D5D;">
	    			<div>
					    ...
					    %>			
					     		<li>
					     			<a <% if(cb.getCname().equals(tcinema)){ %> style="border : 5px ridge #F2CB61;" <%} %> id="tm2" href="<%= request.getContextPath() %>/MY/Home/Ticket/home_ticket_movie_cinema_time.jsp?tmovie=<%= tmovie %>&tcinema=<%= cb.getCname() %>"><%= cb.getCname() %> </a>
					     		</li>		
					    <%	
					     	}
					     %> 
