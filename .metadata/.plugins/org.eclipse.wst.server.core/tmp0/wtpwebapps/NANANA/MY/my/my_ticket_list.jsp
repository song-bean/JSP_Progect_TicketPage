		...
		<tr>
			<td valign="top" width="150" style="border-right: 0.1px solid #5D5D5D;">
				...
				<table border = "0" id="mytable1">
					<tr>
						<td height="60">
							<a href="<%= request.getContextPath() %>/MY/my/my_ticket_list.jsp" class="f2" id="color2">나의 예매내역</a>
						</td>
					<tr>
					<tr>
						<td height="60">
							<a href="<%= request.getContextPath() %>/MY/my/my_detail.jsp" class="f2" id="color1" id="color1">내 정보 보기</a>
						</td>
					</tr>
					<tr>
						<td height="60">
