		...
		<tr>
			<td valign="top" width="150" style="border-right: 0.1px solid #5D5D5D;">
				...
				<table border = "0" id="mytable1">
					...
					<tr>
						<td height="60">
							<a href="<%= request.getContextPath() %>/MY/my/my_update_pwCheck.jsp" class="f2" id="color2">회원 정보 수정</a>
						</td>
					</tr>
					<tr>
						<td height="60">
					...
					<tr>
						<td height="60">
							<a href="<%= request.getContextPath() %>/MY/my/my_delete.jsp" class="f2" id="color1">회원 탈퇴</a>
						</td>
					</tr>
				</table>
			</td>
			<td valign="top">
				<table border="0">
					...
					<tr>
						<td>
							<form name="pwCheckFrom" method="post" action="<%= request.getContextPath() %>/MY/my/my_update_pwCheck_Proc.jsp">
								<table border="0" width="90%">
									...
									<tr>
										<td>
										<br>
											<input type="submit" value="비밀번호 확인" class="form-control" id="sub">
										</td>
									</tr>
								</table>	
							</form>
