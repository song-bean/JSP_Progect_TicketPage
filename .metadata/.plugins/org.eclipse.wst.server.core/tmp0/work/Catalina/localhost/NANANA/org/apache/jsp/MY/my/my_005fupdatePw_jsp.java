 ...
 * Generated at: 2023-04-18 02:48:12 UTC
...
public final class my_005fupdatePw_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String db_password = udao.getPwById(sid);
      ...
      out.write("<script type=\"text/javascript\">\n");
      out.write("	var pwuse;\n");
      out.write("	var pwsame;\n");
      out.write("	function PwCheck(){\n");
      out.write("		if($('input[name=password_cur]').val( ) == \"\"){ \n");
      out.write("			$(\"#pw_curMessage\").html('<font color=\"#CC3D3D\">현재 비밀번호를 입력하세요.<font>').show();\n");
      out.write("			$('input[name=password_cur]').focus();\n");
      out.write("			return false;\n");
      out.write("		}\n");
      out.write("		\n");
      out.write("		if($('input[name=password]').val()==\"\"){\n");
      out.write("			$(\"#pwMessage\").html('<font color=\"#CC3D3D\">변경할 비밀번호를 입력하세요.<font>').show();\n");
      out.write("			$('input[name=password]').focus();\n");
      out.write("			return false;\n");
      out.write("		}\n");
      out.write("		\n");
      out.write("		if(pwuse == \"pwerror\"){\n");
      out.write("			$('input[name=password]').select();\n");
      out.write("			$(\"#pwMessage\").html('<font color=\"#CC3D3D\">비밀번호를 형식이 틀렸습니다.<font>').show();\n");
      out.write("			return false;\n");
      out.write("		}\n");
      out.write("		\n");
      out.write("		if(pwsame == 'nosame'){\n");
      ...
      out.write("			$('input[name=password_cur]').select();\n");
      out.write("			return false;\n");
      out.write("		}\n");
      out.write("	}//PwCheck()\n");
      out.write("	\n");
      out.write("	function pwkeyd(){\n");
      out.write("		$('#pwMessage').css('display','none');\n");
      out.write("	}//pwkeyd()\n");
      out.write("	\n");
      out.write("	function pw_curkeyd(){\n");
      out.write("		$('#pw_curMessage').css('display','none');\n");
      out.write("	}//pw_curkeyd()\n");
      out.write("	\n");
      out.write("	function pwcheck(){\n");
      out.write("		pw = $('input[name=password]').val();\n");
      out.write("		\n");
      out.write("		var regexp = /^[a-zA-Z0-9`~!@#$%^&*()-_=+]{8,16}$/;\n");
      out.write("		if(!regexp.test(pw)){\n");
      out.write("			$(\"#pwMessage\").html('<font color=\"#CC3D3D\">비밀번호를 형식이 틀렸습니다.<font>').show();\n");
      out.write("			pwuse = \"pwerror\";\n");
      out.write("		}\n");
      out.write("		\n");
      out.write("		var chk_num = pw.search(/[0-9]/);\n");
      out.write("		var chk_eng = pw.search(/[a-z]/i);\n");
      out.write("		var chk_spe = pw.search(/[\\W]/);\n");
      out.write("		\n");
      out.write("		if(chk_num <0 || chk_eng < 0 || chk_spe < 0){\n");
      out.write("			$(\"#pwMessage\").html('<font color=\"#CC3D3D\">비밀번호를 형식이 틀렸습니다.<font>').show();\n");
      out.write("			pwuse = \"pwerror\";\n");
      out.write("		}\n");
      out.write("		else{\n");
      ...
      out.write("	}//pwcheck()\n");
      out.write("\n");
      out.write("	function pw2check(){\n");
      out.write("		if($('input[name=password]').val() == $('input[name=password2]').val()){\n");
      out.write("			$('#pwCheck').attr('class','');\n");
      out.write("			$('#pw2Message').html('<font color=\"#6799FF\">비밀번호 일치</font>');\n");
      out.write("			pwsame = \"same\";\n");
      out.write("		}\n");
      out.write("		else{\n");
      out.write("			$('#pwCheck').attr('class','form-group has-error');\n");
      out.write("			$('#pw2Message').html('<font color=\"#CC3D3D\">비밀번호 일치하지 않습니다.</font>');\n");
      out.write("			pwsame = \"nosame\";\n");
      out.write("		}\n");
      out.write("	}//pw2check()\n");
      out.write("\n");
      out.write("</script> \n");
      ...
      out.write("\n");
      out.write("	<tr>\n");
      out.write("		<td align=\"center\" colspan=\"1\" style=\"color : white\" height=\"20\" height=\"20\">\n");
      ...
      out.write("					<tr>\n");
      out.write("						<td height=\"60\">\n");
      out.write("							<a href=\"my_detail.jsp\" class=\"f2\" id=\"color1\" id=\"color1\">내 정보 보기</a>\n");
      out.write("						</td>\n");
      out.write("					</tr>\n");
      out.write("					<tr>\n");
      out.write("						<td height=\"60\">\n");
      out.write("							<a href=\"my_update_pwCheck.jsp\" class=\"f2\" id=\"color1\">회원 정보 수정</a>\n");
      out.write("						</td>\n");
      out.write("					</tr>\n");
      out.write("					<tr>\n");
      out.write("						<td height=\"60\">\n");
      out.write("							<a href=\"my_updatePw.jsp\" class=\"f2\" id=\"color2\">비밀번호 변경</a>\n");
      out.write("						</td>\n");
      out.write("					</tr>\n");
      out.write("					<tr>\n");
      out.write("						<td height=\"60\">\n");
      out.write("							<a href=\"my_delete.jsp\" class=\"f2\" id=\"color1\">회원 탈퇴</a>\n");
      out.write("						</td>\n");
      out.write("					</tr>\n");
      out.write("				</table>\n");
      out.write("			</td>\n");
      ...
      out.print( request.getContextPath() );
      out.write("/MY/my/my_updatePw_proc.jsp\" method=\"post\" onSubmit=\"return PwCheck()\">\n");
      out.write("								<table border=\"0\" width=\"90%\">\n");
      out.write("									<tr>\n");
      out.write("										<td>\n");
      out.write("											<h5>현재 비밀번호</h5>\n");
      out.write("											<input type=\"password\" class=\"form-control\" name=\"password_cur\" onkeydown=\"return pw_curkeyd()\">\n");
      out.write("											<div id=\"pw_curMessage\"></div>\n");
      out.write("										</td>\n");
      out.write("									</tr>\n");
      out.write("									<tr>\n");
      out.write("										<td>\n");
      out.write("											<h5>변경할 비밀번호</h5>\n");
      out.write("											<input type=\"password\" class=\"form-control\" name=\"password\" placeholder=\"8~16자 영문 대 소문자, 숫자, 특수문자 조합\" onkeyup=\"return pwcheck()\" onkeydown=\"return pwkeyd()\">\n");
      ...
      out.write("									<tr>\n");
      out.write("										<td>\n");
      out.write("											<div id=\"pwCheck\">\n");
      out.write("												<h5>변경할 비밀번호 확인</h5>\n");
      out.write("												<input type=\"password\" class=\"form-control\" name=\"password2\" onkeyup=\"pw2check()\">\n");
      out.write("												<div id=\"pw2Message\"></div>\n");
      out.write("											</div>\n");
      out.write("										</td>\n");
      out.write("									</tr>\n");
      out.write("									\n");
      ...
      out.write("										<td>\n");
      out.write("										<br>\n");
      out.write("											<input type=\"submit\" value=\"비밀번호 변경\" class=\"form-control\" id=\"sub\">\n");
      out.write("										</td>\n");
      out.write("									</tr>\n");
      out.write("								</table>	\n");
      out.write("							</form>\n");
