		...
		<div id="carousel-example-generic" class="carousel slide">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="<%=request.getContextPath()%>/carousel/carousel_1.JPG"
						alt="First slide" width="1000" height="400">
				</div>
				<div class="item">
					<img src="<%=request.getContextPath()%>/carousel/carousel_2.JPG"
						alt="Second slide" width="1000" height="400">
				</div>
				<div class="item">
					<img src="<%=request.getContextPath()%>/carousel/carousel_3.JPG"
						alt="Third slide" width="1000" height="400">
				</div>
				<div class="item">
					<img src="<%=request.getContextPath()%>/carousel/carousel_4.JPG"
						alt="Fourth slide" width="1000" height="400">
				</div>
			</div>
