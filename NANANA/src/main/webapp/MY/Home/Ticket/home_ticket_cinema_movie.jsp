			...
			<tr>
				<td style="border-left : 1px solid #5D5D5D;border-right : 1px solid #5D5D5D;">
	    			<div>
					    ...
					    %>			
					     		<li>
					     			<a id="tm2" <% if(cb.getCname().equals(tcinema)){ %> style="border : 5px ridge #F2CB61;" <%} %> href="<%= request.getContextPath() %>/MY/Home/Ticket/home_ticket_cinema_movie.jsp?tcinema=<%= cb.getCname() %>"><%= cb.getCname() %></a>
					     		</li>		
					    <%	
					     	}
					     %> 
				...
				<td width="50%" style="border-left : 1px solid #5D5D5D;border-right : 1px solid #5D5D5D;">
					 <div>
					    ...
					    %>			
					    		<li>
					     			<a id="tm1" href="<%= request.getContextPath() %>/MY/Home/Ticket/home_ticket_cinema_movie_time.jsp?tmovie=<%= mb.getMname() %>&tcinema=<%= tcinema %>">
					    ...
					    %>			
					      		<li>
					     			<a id="tm1" href="<%= request.getContextPath() %>/MY/Home/Ticket/home_ticket_cinema_movie_time.jsp?tmovie=<%= mb.getMname() %>&tcinema=<%= tcinema %>">
					     				<img src="<%= request.getContextPath() %>/images/15.jpg" width="15"> <%= mb.getMname() %>
					     			</a>
					     		</li>	
					   	<%
					     		}
					   	...
					   	%>
					     		<li>
					     			<a id="tm1" href="<%= request.getContextPath() %>/MY/Home/Ticket/home_ticket_cinema_movie_time.jsp?tmovie=<%= mb.getMname() %>&tcinema=<%= tcinema %>">
					     				<img src="<%= request.getContextPath() %>/images/12.jpg" width="15"> <%= mb.getMname() %>
					     			</a>
					     		</li>	
						<%			
					     		}
						...
						%>
								<li>
					     			<a id="tm1" href="<%= request.getContextPath() %>/MY/Home/Ticket/home_ticket_cinema_movie_time.jsp?tmovie=<%= mb.getMname() %>&tcinema=<%= tcinema %>">
					     				<img src="<%= request.getContextPath() %>/images/0.jpg" width="15"> <%= mb.getMname() %>
					     			</a>
					     		</li>	
					    <%	
					     		}
