					 ...
					 <div>
					    ...
					    <%
					     	for( MovieBean mb : mlist){
					     		if(mb.getMage() == 18){
					    %>			
					     			<li><a id="tm1" href="<%= request.getContextPath() %>/MY/Home/Ticket/home_ticket_movie_cinema.jsp?tmovie=<%= mb.getMname() %>"><img src="<%= request.getContextPath() %>/images/18.jpg" width="15"> <%= mb.getMname() %></a></li>
					    <%
					     		}
					     		else if(mb.getMage() == 15){
					    %>			
					      			<li><a id="tm1" href="<%= request.getContextPath() %>/MY/Home/Ticket/home_ticket_movie_cinema.jsp?tmovie=<%= mb.getMname() %>"><img src="<%= request.getContextPath() %>/images/15.jpg" width="13"> <%= mb.getMname() %></a></li>
					   	<%
					     		}
					     		else if(mb.getMage() == 12){
					   	%>
					     			<li><a id="tm1" href="<%= request.getContextPath() %>/MY/Home/Ticket/home_ticket_movie_cinema.jsp?tmovie=<%= mb.getMname() %>"><img src="<%= request.getContextPath() %>/images/12.jpg" width="13"> <%= mb.getMname() %></a></li>
						<%			
					     		}
					     		else{		
						%>
									<li><a id="tm1" href="<%= request.getContextPath() %>/MY/Home/Ticket/home_ticket_movie_cinema.jsp?tmovie=<%= mb.getMname() %>"><img src="<%= request.getContextPath() %>/images/0.jpg" width="13"> <%= mb.getMname() %></a></li>
					    <%	
					     		}
					     	}
					     %> 
