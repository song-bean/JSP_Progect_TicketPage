...
<%
	...
	String[] time = {"09:20 ~ 11:40" ,"11:40 ~ 14:00" ,"14:00 ~ 16:20", "16:20 ~ 18:40", "18:40 ~ 21:00"}; 
%>
			...
			<tr>
				<td style="border-left : 1px solid #5D5D5D;border-right : 1px solid #5D5D5D;">
	    			<div>
					    ...
					    %>			
					     		<li>
					     			<a id="tm2" <% if(cb.getCname().equals(tcinema)){ %> style="border : 5px ridge #F2CB61;" <%} %> href="home_ticket_cinema_movie.jsp?tcinema=<%= cb.getCname() %>"><%= cb.getCname() %></a>
					     		</li>		
					    <%	
					     	}
					     %> 
				...
				<td width="50%" style="border-left : 1px solid #5D5D5D;border-right : 1px solid #5D5D5D;">
					 <div>
					    ...
					    <%
						    ...
						    %>			
						    		<li>
					     				<a id="tm1" <% if(mb.getMname().equals(tmovie)){ %> style="border : 5px ridge pink;" <%} %> href="<%= request.getContextPath() %>/MY/Home/Ticket/home_ticket_cinema_movie_time.jsp?tmovie=<%= mb.getMname() %>&tcinema=<%= tcinema %>">
	    		...
	    		<td style="border-left : 1px solid #5D5D5D;border-right : 1px solid #5D5D5D;">
	    			<div>
					    ...
					    %>			
					     		<li>
					     			<a id="tm3" href="<%= request.getContextPath() %>/MY/Home/Ticket/home_ticket_seat.jsp?tmovie=<%= tmovie %>&tcinema=<%= tcinema %>&time=<%= time2 %>"><%= time2 %></a>
					     		</li>		
					    <%	
					     	}
					     %> 
