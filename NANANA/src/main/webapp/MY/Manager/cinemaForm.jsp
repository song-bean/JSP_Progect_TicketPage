	...
	<br>
		<form method="post" action="cinamaProc.jsp">
			<table class="ctable">
				<tr>
					<td>극장 이름</td>
					<td><input type="text" class="form-control" name="cname" id="i1" required></td>
				</tr>
				...
				<tr>
					<td>주소</td>
					<td><input type="text" class="form-control" name="address" id="i1" required></td>
				</tr>
				...
				<tr>
					...
					<td class="tel">
						&nbsp;&nbsp;
						<input type="text" name="tel1" size="5" maxlength="4" style="background : #353535; border : 0.1px solid white;"> -
						<input type="text" name="tel2" size="5" maxlength="4" style="background : #353535; border : 0.1px solid white;">
					</td>
				</tr>
				<tr>
