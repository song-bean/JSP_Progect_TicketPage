...
<td colspan="5" align="center" style="font-family: 'Nanum Pen Script', cursive;font-size: 25px;">
	<b>문의 수정</b>
	<br><br>
<form name="writeform" action="<%= request.getContextPath() %>/MY/Inquiry/inquiry_update_Proc.jsp" method="post" onSubmit="return inquiryCheck()">
	<input type="hidden" name="ino" value="<%= ib.getIno() %>">
	<input type="hidden" name="pageNum" value="<%= pageNum %>">
	<table class="itable" border="0">
		<tr>
			<td>제목</td>
			<td width="400"><input type="text" class="form-control" name="subject" id="i1" value="<%= ib.getSubject() %>"></td>
		</tr>
				
		<tr>
			<td>내용</td>
			<td>
				<textarea class="form-control" name="content" id="i1" rows="5"><%= ib.getContent() %></textarea>
			</td>
		</tr>
